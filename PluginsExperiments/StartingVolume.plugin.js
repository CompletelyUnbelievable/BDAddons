...
class StartingVolume {
	...
	initialize(){
		...
		this.iframeHandler=this.delegateMediaEvents(this.topElement,'click',this.embedIframe,'load',this.iframeHandling);
	...
	stop(){
		...
		this.removeDelegatedMediaEvents(this.topElement,'click',this.embedIframe,'load',this.iframeHandling,this.iframeHandler);
	}
